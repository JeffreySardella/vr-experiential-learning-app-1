...
function ManageAdmins({ user }: { user: any }) {
  ...
  const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const submit = async () => {
      try {
        ...
        await fetch(`${process.env.API_URL}/api/auth/invite/admins/`, {
          method: "POST",
          credentials: "include",
          headers: {
  ...
  return (
    <PageContainer sx={{ background: "#0a0f1e" }}>
      <Box sx={{ maxWidth: 480, mx: "auto", mt: 4 }}>
        <SectionHeader title="Invite Admin Users" gradient align="center" />
...
export default withAuth(ManageAdmins, ["admin"]);
