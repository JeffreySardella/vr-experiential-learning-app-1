...
SECRET_KEY = 'django-insecure-zqfuzv5b1sbk(423=b3h9siyzvcmu+ccoe(v0rq81ky!u=v==#'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # JWTCookieAuthentication that authenticates via cookie (or header for mobile apps)
...
REST_AUTH = {
    ...
    'USER_DETAILS_SERIALIZER': 'custom_auth.serializers.CustomUserDetailsSerializer',
    # JWT in cookies/header will be the method of authentication for end users
    'TOKEN_MODEL': None,
    'TOKEN_CREATOR': None,
    'SESSION_LOGIN': False,
    'USE_JWT': True,
    ...
    'JWT_AUTH_COOKIE_USE_CSRF': False,  # TODO address later
}
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # TODO: come back to later
